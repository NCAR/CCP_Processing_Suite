PROGRAM main
  ...
  !	        dst_file       == Regridded output netcdf template
  ...
  !
  !   CVS:$Id: main_ccsm_ice.F90,v 1.2 2005/03/31 17:36:47 strandwg Exp $
  !-----------------------------------------------------------------------------
  ...
  DO
     dst_var = 'unknown'
     READ(UNIT=stdin, NML=ccsm_ice_rgd_nml, IOSTAT=ios, ERR=10, END=20)
     dst_var = src_var
     nvars = 1
     DO ivar = 1,max_vars
